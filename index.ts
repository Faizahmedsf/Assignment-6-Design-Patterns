import { userData, User, data, IUserGui, userOperation, TempSubject, TempObserver, bonus } from "./interfaces/interfaces";
...
class dataSource implements data {
    ...
    // using singleton design pattern beacuse we just want a single instance of this data source class
